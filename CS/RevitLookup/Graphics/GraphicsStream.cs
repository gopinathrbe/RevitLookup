...
namespace RevitLookup.Graphics
{
	...
	public abstract class GraphicsStream
	{
		...
		public void PushGeometryOptions(Options opts)
		{
			m_geomOptionsStack.Push(opts);
		}

		public void PopGeometryOptions()
		{
			m_geomOptionsStack.Pop();
		}

		public Options CurrentGeometryOptions
		{
		...
		public virtual Double DeviationForCurves()
		{
			return 0.5;
		}

		public virtual Double DeviationForCurves(XYZ samplePt)
		{
			return 0.5;
		}
		...
		private void StreamFaceGeoometry(Face face)
		{
		...
		public virtual void Stream(Autodesk.Revit.DB.GeometryInstance inst)
		{
