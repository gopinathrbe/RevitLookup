...
namespace RevitLookup.Xml.Forms
{
	...
	public class Dom : System.Windows.Forms.Form
	{
		...
		public Dom(System.Xml.XmlDocument xmlDoc)
		{
			m_xmlDoc = xmlDoc;
		...
		private void MakeTree(System.Xml.XmlNode xmlNode, TreeNode parentNode)
		{
		...
		private void TreeNodeSelected(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
		...
		private void OnBnOwnerDoc(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
			MoveToNewNodeInTree(curNode.OwnerDocument);
		}

		private void OnBnPrevSibling(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
			MoveToNewNodeInTree(curNode.PreviousSibling);
		}

		private void OnBnNextSibling(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
			MoveToNewNodeInTree(curNode.NextSibling);
		}

		private void OnBnFirstChild(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
			MoveToNewNodeInTree(curNode.FirstChild);
		}

		private void OnBnLastChild(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
			MoveToNewNodeInTree(curNode.LastChild);
		}

		private void OnBnDocElement(object sender, System.EventArgs e)
		{
		...
		private void OnBnSelectSingleNode(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
		...
		private void OnBnSelectNodes(object sender, System.EventArgs e)
		{
			XmlNode curNode = (XmlNode)m_tvDom.SelectedNode.Tag;
		...
		private void OnRbChanged_LabelDisplay(object sender, System.EventArgs e)
		{
			LoadTree();     // reload the tree with our new display preference set
		}

		private void OnCbChanged_NodeDisplay(object sender, System.EventArgs e)
		{
			LoadTree();     // reload the tree with our new display preference set
		}

		private void DataItemSelected(object sender, System.EventArgs e)
		{
