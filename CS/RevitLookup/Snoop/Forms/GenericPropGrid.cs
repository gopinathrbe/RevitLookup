...
namespace RevitLookup.Snoop.Forms
{
	...
	public class GenericPropGrid : System.Windows.Forms.Form
	{
		...
		private void OnShowObjInfo(object sender, System.EventArgs e)
		{
		...
		private void OnShowClassInfo(object sender, System.EventArgs e)
		{
			object selObj = m_pgProps.SelectedGridItem.Value;
		...
		private void OnMenuContextPopup(object sender, System.EventArgs e)
		{
