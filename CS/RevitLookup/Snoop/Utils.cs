...
namespace RevitLookup.Snoop
{
	...
	public class Utils
	{
		...
		public static void Display(ListView lvCur, Snoop.Collectors.Collector snoopCollector)
		{
			lvCur.BeginUpdate();
			lvCur.Items.Clear();
		...
		public static void DataItemSelected(ListView lvCur)
		{
		...
		public static void CopyToClipboard(ListViewItem lvItem, Boolean multipleItems)
		{
		...
		public static Int32 Print(String title, ListView lv, System.Drawing.Printing.PrintPageEventArgs e, Int32 maxFieldWidth, Int32 maxValueWidth, Int32 currentItem)
		{
		...
		public static void UpdatePrintSettings(PrintDocument doc, TreeView tv, ListView lv, ref Int32[] widthArray)
		{
		...
		public static void UpdatePrintSettings(ListView lv, ref Int32[] widthArray)
		{
			widthArray = Utils.GetMaximumColumnWidths(lv);
		}
