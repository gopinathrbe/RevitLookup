...
#if !Revit2017
        if (expectedType == typeof (Autodesk.Revit.DB.Visual.AssetProperty))
                    return new Data.AssetProperty(info.Name, elem as Autodesk.Revit.DB.Visual.AssetProperties, returnValue as Autodesk.Revit.DB.Visual.AssetProperty);
#endif
